...
public class Hornet extends GraphicsProgram {
    ...
    /* Faizah's Round1 extension starts */
    public void pauseHornet() {
        if (moveTask != null) moveTask.cancel();
        if (actionTask != null) actionTask.cancel();
    }

    public void resumeHornet() {
        spawnHornet(); // Reschedules tasks to resume behavior
    }
    /* Faizah's Round1 extension ends */
